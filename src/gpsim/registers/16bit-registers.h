...
class FSRL : public SfrReg
{
public:
    FSRL(Processor *, const char *pName , Indirect_Addressing *pIAM);
...
class FSRH : public SfrReg
{
public:
    FSRH(Processor *, const char *pName , Indirect_Addressing *pIAM);
...
class INDF16 : public SfrReg
{
public:
    INDF16(Processor *, const char *pName , Indirect_Addressing *pIAM);
...
class PREINC : public SfrReg
{
public:
    PREINC(Processor *, const char *pName , Indirect_Addressing *pIAM);
...
class POSTINC : public SfrReg
{
public:
    POSTINC(Processor *, const char *pName , Indirect_Addressing *pIAM);
...
class POSTDEC : public SfrReg
{
public:
    POSTDEC(Processor *, const char *pName , Indirect_Addressing *pIAM);
...
class PLUSW : public SfrReg
{
public:
    PLUSW(Processor *, const char *pName , Indirect_Addressing *pIAM);
...
public:
    ...
    PCL16(Processor *, const char *pName =0);
};
...
public:
    ...
    STKPTR16(Processor *, const char *pName =0);
...
class TOSU : public SfrReg
{
public:
    TOSU(Processor *, const char *pName =0);
...
public:
    ...
    CPUSTA(Processor *, const char *pName =0);
};
...
public:
    ...
    T0CON(Processor *, const char *pName =0);
    void put(uint new_value);
    void initialize();
};
...
class TMR0H : public SfrReg
{
public:

    TMR0H(Processor *, const char *pName =0);
...
public:
    ...
    TMR0_16(Processor *, const char *pName =0);
                                                      ...
                                                      CCPRL *ccpr2l;
                                                                               TMRL  *tmr1l;
                                                                                                        T1CON *t1con;
                                                                                                                                 ...
                                                                                                                                 T3CON(Processor *pCpu, const char *pName =0);
...
public:
    ...
    LVDCON(Processor *, const char *pName =0);
};
...
class HLVDCON : public  SfrReg, public TriggerObject
{
public:
    enum
    {
    ...
    HLVDCON(Processor *pCpu, const char *pName );
    ~HLVDCON();
    void put(uint new_value);
    void callback();
