...
{
    if     ( pinName.contains( "RS" )) return m_pinRS;
    else if( pinName.contains("RW" )) return m_pinRW;
    else if( pinName.contains( "En" )) return m_pinEn;
    else if( pinName.contains( "dataPin" ))
    {
        int pin = pinName.remove("dataPin").toInt();
