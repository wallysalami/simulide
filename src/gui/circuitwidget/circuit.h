...
class MAINMODULE_EXPORT Circuit : public QGraphicsScene
{
    ...
    Q_PROPERTY( double  Simu_Step_nS READ stepNs     WRITE setStepNs     DESIGNABLE true USER true )
 ...
 static Circuit* self() { return m_pSelf; }
        ...
        Pin* getConPin( QString pinId, QHash<QString, QString>* idMap );
